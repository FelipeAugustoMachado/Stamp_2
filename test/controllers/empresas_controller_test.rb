...
class EmpresasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create empresa" do
    assert_difference('Empresa.count') do
      post empresas_url, params: { empresa: { CNPJ: @empresa.CNPJ, Nome: @empresa.Nome, descricao: @empresa.descricao, email: @empresa.email, senha: @empresa.senha } }
    end
  ...
  test "should update empresa" do
    patch empresa_url(@empresa), params: { empresa: { CNPJ: @empresa.CNPJ, Nome: @empresa.Nome, descricao: @empresa.descricao, email: @empresa.email, senha: @empresa.senha } }
